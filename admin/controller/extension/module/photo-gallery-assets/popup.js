(function($) {
    ...
    let $deactivateForm  = jQuery('#photo-gallery-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('photo-gallery-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'photo-gallery-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('photo-gallery-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_photo_gallery.php', jQuery.param(data)).then(function(result) {
