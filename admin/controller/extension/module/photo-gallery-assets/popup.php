<link rel="stylesheet" href="./controller/extension/module/photo-gallery-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="photo-gallery-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Photo Gallery</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/photo-gallery-assets/popup.js';
