...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'photo-gallery';
        $this->app_name = 'Photo Gallery';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/photo-gallery-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightPhotoGallery extends Controller {
    private $error = array();

    public $params = NULL;

    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/photo-gallery/?utm_source=portals&utm_medium=opencart&utm_campaign=photo-gallery&utm_content=sign-up';

    public function index() {
        $this->load->language('extension/module/elfsight_photo_gallery');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('module_elfsight_photo_gallery', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_photo_gallery', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_photo_gallery_status'])) {
            $data['module_photo_gallery_status'] = $this->request->post['module_photo_gallery_status'];
        } else {
            $data['module_photo_gallery_status'] = $this->config->get('module_photo_gallery_status');
        }

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');

        $this->response->setOutput($this->load->view('extension/module/elfsight_photo_gallery', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/elfsight_photo_gallery')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/photo-gallery-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/photo-gallery-assets/popup.php';
    }
